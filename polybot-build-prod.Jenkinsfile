                ...
                withCredentials([string(credentialsId: 'amiraniv-DH-prod-U', variable: 'AmiranIV-DH-U'), string(credentialsId: 'amiraniv-prod-DH-Pass', variable: 'AmiranIV-DH-Pass')])
                    {
                         sh '''
                            ...
                            docker build -t jenkinspoly-prod-test:v3.0 .
                            docker tag jenkinspoly-prod-test:v3.0 amiraniv/jenkinspoly-prod-test:v3.0
                            docker push amiraniv/jenkinspoly-prod-test:v3.0
                        '''
                    }
                }
            }
        ...
        stage('Trigger Deploy') {
            steps {
                build job: 'prod/polybot-build-prod', wait: false, parameters: [
                    string(name: 'polybot-prod-test', value: 'amiraniv/jenkinspoly-prod-test:v3.0')
                ]
            }
        }
    }
